...
<template>
  <div class="fashion-demo" dir="rtl">
    <div class="demo-bar"><span>نمونه طراحی سایت بوتیک و مد</span><NuxtLink to="/services">بازگشت به خدمات FADAKAR ←</NuxtLink></div>
    ...
    <aside class="chapter-rail">
      <button v-for="(chapter, index) in chapters" :key="chapter" :class="{ active: activeChapter === index }" @click="document.querySelector(`[data-chapter=\"${index}\"]`)?.scrollIntoView({ behavior: 'smooth' })">
        <span>{{ chapter }}</span>
      </button>
    </aside>
    ...
    <main>
      <section id="manifesto" data-chapter="0" class="hero-chapter chapter">
        <div class="hero-media"><img src="https://images.unsplash.com/photo-1733322991133-2de13aa12c57?auto=format&fit=crop&fm=jpg&q=80&w=2600" alt="مدل روی ران‌وی"><div class="hero-vignette"></div><div class="scanlines"></div></div>
        <div class="hero-copy">
