...
const handleScroll = () => {
  ...
  if (heroMedia.value) {
    heroMedia.value.style.transform = `translate3d(0, ${y * 0.35}px, 0)`
...
const looks = [
  { label: 'SILHOUETTE 01', title: 'The Red Line', image: '/images/demos/fashion/look-01.jpg', note: 'حرکت پارچه، فرم اغراق‌شده و قرمز به‌عنوان تنها ضربه رنگ.' },
  { label: 'SILHOUETTE 02', title: 'Quiet Geometry', image: '/images/demos/fashion/look-02.jpg', note: 'خطوط تمیز، فضای خالی و نسبت‌های معماری برای یک هویت مینیمال.' },
  { label: 'SILHOUETTE 03', title: 'Soft Power', image: '/images/demos/fashion/look-03.jpg', note: 'ترکیب tailoring و volume برای شخصیتی که آرام نیست.' },
  { label: 'SILHOUETTE 04', title: 'Liquid Light', image: '/images/demos/fashion/look-04.jpg', note: 'بافت براق، بدن و نور به‌عنوان بخشی از composition.' },
]
  ...
  <div class="fashion-demo" dir="rtl">
    ...
    <main>
      <section id="manifesto" data-chapter="0" class="hero-chapter chapter">
        <div ref="heroMedia" class="hero-media">
      ...
      <section class="editorial-split chapter dark-chapter" data-chapter="3">
        <div class="editorial-image reveal"><img src="/images/demos/fashion/editorial.jpg" alt="ادیتوریال مد"><div class="image-counter">03 / 04</div></div>
      ...
      <section class="closing-chapter chapter">
        <div class="closing-bg"><img src="/images/demos/fashion/closing.jpg" alt="فشن شو"></div>
