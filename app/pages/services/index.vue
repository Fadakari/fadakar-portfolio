...
const copy = computed(() => locale.value === 'fa' ? {
  ...
  services: [
    ...
    { title: 'منوی دیجیتال و سایت رستوران', short: 'منوی سریع و موبایل‌محور برای رستوران، کافه، فست‌فود، هتل و مجموعه‌های غذایی.', detail: 'دسته‌بندی منو، تصاویر، قیمت، توضیحات، اطلاعات تماس، مسیر دسترسی و تجربه‌ای که مشتری بدون دردسر در موبایل استفاده کند.' },
