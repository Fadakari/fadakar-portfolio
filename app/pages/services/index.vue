...
const copy = computed(() => locale.value === 'fa' ? {
  ...
  services: [
    ...
    { title: 'Digital menu & restaurant website', short: 'A fast, mobile-first menu for restaurants, cafes, fast food, hotels and food businesses.', detail: 'Menu categories, images, pricing, descriptions, contact information, location and a frictionless mobile experience.' },
