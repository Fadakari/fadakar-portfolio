...
.section-heading { max-width: 820px; margin-bottom: 4rem; }.section-heading.compact { max-width: 850px; }.services-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 1px; background: rgba(255,255,255,.1); border: 1px solid rgba(255,255,255,.1); }.service-card { min-height: 390px; background: radial-gradient(circle at 100% 0%, color-mix(in srgb, var(--accent) 4%, #08080b), #08080b 60%); padding: 2rem; padding-bottom: 3rem; position: relative; transition: all .4s ease; z-index: 1; }.service-card::before { content: ''; position: absolute; inset: 0; background: radial-gradient(circle at top, color-mix(in srgb, var(--accent) 12%, transparent), transparent 70%); opacity: 0; transition: opacity .4s ease; z-index: 0; pointer-events: none; }.service-card:hover { transform: translateY(-4px); z-index: 2; box-shadow: 0 15px 35px -10px color-mix(in srgb, var(--accent) 25%, transparent); }.service-card:hover::before { opacity: 1; }.service-number { position: relative; z-index: 1; color: #555561; font-size: .7rem; letter-spacing: .12em; }.service-icon { position: relative; z-index: 1; height: 48px; width: 48px; margin: 2rem 0 1.8rem; border: 1px solid color-mix(in srgb, var(--accent) 55%, transparent); display: flex; align-items: center; justify-content: center; gap: 4px; transform: rotate(45deg); box-shadow: 0 0 15px color-mix(in srgb, var(--accent) 20%, transparent); }.service-icon span { width: 4px; height: 18px; background: var(--accent); }.service-icon span:nth-child(2) { height: 28px; background: color-mix(in srgb, var(--accent) 60%, white); }.service-card h3 { position: relative; z-index: 1; font-size: 1.25rem; color: #fff; margin-bottom: .8rem; text-shadow: 0 0 20px color-mix(in srgb, var(--accent) 20%, transparent); }.service-short { position: relative; z-index: 1; color: #b3b3bd; line-height: 1.7; font-size: .95rem; }.service-detail { position: relative; z-index: 1; color: #6f6f7a; line-height: 1.7; font-size: .83rem; margin-top: .8rem; }.service-cta { position: absolute; z-index: 1; bottom: 1rem; color: var(--accent); text-decoration: none; font-size: .78rem; font-weight: 700; }.service-cta span { display: inline-block; margin-left: .4rem; transition: transform .2s; }.service-cta:hover span { transform: translate(3px,-3px); }
