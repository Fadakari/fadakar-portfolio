...
<style scoped>
.about-page { min-height: 100vh; background: #050505; color: #cbd5e1; position: relative; overflow: hidden; }
...
.about-title { margin: 1.5rem 0 2rem; font-size: clamp(3.2rem, 6.5vw, 4rem); line-height: 1.04; letter-spacing: -.045em; white-space: pre-line; color: #f8fafc; }
.hero-intro { max-width: 680px; color: #cbd5e1; font-size: clamp(1.05rem, 1.5vw, 1.3rem); line-height: 2; }
.scroll-link { margin-top: 3rem; display: inline-flex; align-items: center; gap: 1rem; background: transparent; border: 0; color: #cbd5e1; cursor: pointer; font: inherit; padding: 0; }
...
.identity-code { position: absolute; top: 28%; left: 12%; right: 12%; color: #cbd5e1; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: .85rem; line-height: 2.2; direction: ltr; }
...
.section-main { max-width: 850px; }.section-title { font-size: clamp(2.1rem, 4vw, 4.2rem); line-height: 1.2; letter-spacing: -.035em; color: #f8fafc; margin-bottom: 3.5rem; }.body-copy { max-width: 760px; }.body-copy p, .belief-text, .large-copy { color: #cbd5e1; font-size: 1.08rem; line-height: 2.05; margin-bottom: 2rem; }
.belief-section { padding: 10rem 7vw; }
.belief-inner { width: min(1240px, 100%); margin: 0 auto; display: grid; grid-template-columns: 190px minmax(0,1fr); gap: 4rem; }.belief-content { max-width: 980px; }.belief-title { font-size: clamp(2.8rem, 6vw, 6rem); line-height: 1.08; letter-spacing: -.045em; color: #f8fafc; margin-bottom: 3rem; }.belief-text { max-width: 820px; font-size: 1.2rem; }.belief-text.muted { color: #cbd5e1; }
