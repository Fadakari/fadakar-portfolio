...
.main-header.scrolled { background-color: rgba(10, 10, 20, 0.7); backdrop-filter: blur(8px); box-shadow: 0 4px 20px rgba(0, 0, 0, 0.3); }
.brand-name { font-size: 1.8rem; font-weight: 700; color: #fff; text-decoration: none; letter-spacing: 0.05em; transition: color 0.3s ease; }
.brand-name:hover { color: #8a2be2; }
.nav-links { list-style: none; display: flex; gap: 2.5rem; margin: 0; padding: 0; }
.nav-links li a { color: #e0e0e0; text-decoration: none; font-size: 1.1rem; font-weight: 500; position: relative; transition: color 0.3s ease; padding: 0.5rem 0; cursor: pointer; }
.nav-links li a:hover { color: #fff; }
.nav-links li a::after { content: ''; position: absolute; left: 0; bottom: 0; width: 100%; height: 2px; background-color: #8a2be2; transform: scaleX(0); transform-origin: bottom right; transition: transform 0.3s ease-out; }
...
.hamburger-button .line1 { top: 14px; }
.hamburger-button .line2 { top: 22px; }
.hamburger-button .line3 { top: 30px; }
.main-header.menu-open .line1 { transform: translateY(8px) rotate(45deg); }
.main-header.menu-open .line2 { opacity: 0; }
.main-header.menu-open .line3 { transform: translateY(-8px) rotate(-45deg); }

.mobile-menu-panel { position: fixed; top: 0; left: 0; width: 100%; height: 100vh; background-color: rgba(10, 10, 20, 0.95); backdrop-filter: blur(15px); display: flex; justify-content: center; align-items: center; transform: translateX(100%); transition: transform 0.4s cubic-bezier(0.23, 1, 0.32, 1); z-index: 999; }
...
.lang-btn { background: transparent; border: 1px solid rgba(255, 255, 255, 0.1); color: rgba(255, 255, 255, 0.8); padding: 0.4rem 0.8rem; border-radius: 0.5rem; cursor: pointer; transition: all 0.3s ease; min-width: 50px; }
.lang-btn:hover { background: rgba(255, 255, 255, 0.05); color: #fff; }
.lang-dropdown { position: absolute; top: 120%; right: 0; background: rgba(15, 23, 42, 0.9); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 0.5rem; display: flex; flex-direction: column; overflow: hidden; min-width: 100px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.5); z-index: 1000; }
.lang-dropdown button { background: transparent; border: none; color: #cbd5e1; padding: 0.75rem 1rem; text-align: left; cursor: pointer; font-family: inherit; transition: background 0.2s, color 0.2s; }
:global(html[dir='rtl']) .lang-dropdown button { text-align: right; }
.lang-dropdown button:hover { background: rgba(255, 255, 255, 0.05); color: #fff; }
.lang-dropdown button.active-lang { color: #38bdf8; font-weight: 600; background: rgba(56, 189, 248, 0.1); }
