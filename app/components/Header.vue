...
<style scoped>
.main-header{position:fixed;top:0;left:0;width:100%;z-index:1000;transition:background-color .4s ease,backdrop-filter .4s ease,padding .4s ease;color:#27272a;font-family:Inter,system-ui,sans-serif;backdrop-filter:blur(15px)}.header-content{display:flex;justify-content:space-between;align-items:center;padding:1.5rem 4rem;transition:padding .5s cubic-bezier(.23,1,.32,1)}.main-header.scrolled .header-content{padding-top:1rem;padding-bottom:1rem}.main-header.deep-scrolled .header-content{padding-left:15rem;padding-right:15rem}.main-header.scrolled{background-color:rgba(255,255,255,.78);backdrop-filter:blur(8px);box-shadow:0 4px 20px rgba(24,24,27,.08)}.brand-name{font-size:1.8rem;font-weight:800;color:#18181b;text-decoration:none;letter-spacing:.05em}.brand-name:hover{color:#7c3aed}.nav-links{list-style:none;display:flex;gap:2.2rem;margin:0;padding:0}.nav-links li a{color:#3f3f46;text-decoration:none;font-size:1rem;font-weight:600;position:relative;padding:.5rem 0;cursor:pointer}.nav-links li a:hover{color:#7c3aed}.nav-links li a::after{content:'';position:absolute;left:0;bottom:0;width:100%;height:2px;background:#7c3aed;transform:scaleX(0);transform-origin:bottom right;transition:transform .3s ease}.nav-links li a:hover::after{transform:scaleX(1);transform-origin:bottom left}.language-button{margin-left:1.5rem;border:1px solid #d4d4d8;background:rgba(255,255,255,.7);color:#27272a;border-radius:999px;padding:.45rem .8rem;font-weight:700;cursor:pointer}.language-button:hover{border-color:#7c3aed;color:#7c3aed}.hamburger-button{display:none;background:none;border:none;cursor:pointer;z-index:1010;padding:10px}.hamburger-button .line{display:block;width:28px;height:3px;background:#27272a;margin:5px 0;transition:transform .3s ease,opacity .3s ease}.mobile-menu-panel{position:fixed;top:0;left:0;width:100%;height:100vh;background:rgba(255,255,255,.96);backdrop-filter:blur(15px);display:flex;justify-content:center;align-items:center;transform:translateX(100%);transition:transform .4s cubic-bezier(.23,1,.32,1);z-index:999}.mobile-nav-links{list-style:none;padding:0;text-align:center}.mobile-nav-links li{margin-bottom:2rem}.mobile-nav-links li a{color:#18181b;text-decoration:none;font-size:2rem;font-weight:700}.mobile-language-button{border:0;background:none;color:#7c3aed;font-size:1.1rem;font-weight:700;cursor:pointer}.main-header.menu-open .mobile-menu-panel{transform:translateX(0)}.main-header.menu-open .line1{transform:rotate(45deg) translate(6px,6px)}.main-header.menu-open .line2{opacity:0}.main-header.menu-open .line3{transform:rotate(-45deg) translate(6px,-6px)}
