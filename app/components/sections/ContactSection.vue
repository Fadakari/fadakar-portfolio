  ...
  <section id="contact" class="contact-section" :class="{ 'rtl-mode': locale === 'fa' }">
    <div class="section-content internal-scroll">
      <div class="container">
        ...
        <div class="contact-wrapper anim-stagger centered-contact">
          <div class="contact-info">
            ...
            <div class="info-item">
              ...
              <a href="tel:+989228192173" class="info-link">+989228192173</a>
            </div>
            
            <div class="info-item">
              <h3 class="info-title">{{ $t('contact.connect') }}</h3>
              <div class="social-links">
                <a href="https://www.linkedin.com/in/erfan-fadakar-207a03320/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" class="social-icon" title="LinkedIn">
                ...
                <a href="https://t.me/THE_FADAKAR" target="_blank" rel="noopener noreferrer" aria-label="Telegram Profile" class="social-icon" title="Telegram">
                ...
                <a href="https://instagram.com/phadakary" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" class="social-icon" title="Instagram">
                  <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
...
/* ========================================= */
/* تنظیمات ۱۰۰٪ مطمئن برای حالت راست‌چین (فارسی) */
/* ========================================= */
.rtl-mode .contact-info {
  text-align: center; /* چون در مرکز است، در فارسی هم وسط چین بماند زیباتر است */
}
</style>