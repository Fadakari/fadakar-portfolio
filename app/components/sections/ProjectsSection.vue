          ...
          <div class="modal-content glass-panel">
            ...
            <div class="modal-body">
              ...
              <div class="modal-actions">
                <a v-if="selectedProject.liveUrl" :href="selectedProject.liveUrl" target="_blank" rel="noopener noreferrer" :aria-label="`View live demo of ${selectedProject.title}`" class="modal-btn primary">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" class="btn-icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                  {{ $t('projects.live_demo') }}
                </a>
                <a v-if="selectedProject.githubUrl" :href="selectedProject.githubUrl" target="_blank" rel="noopener noreferrer" :aria-label="`View source code of ${selectedProject.title}`" class="modal-btn secondary">
